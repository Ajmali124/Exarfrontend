...
export function ResetPasswordOTPForm() {
  ...
  const onSubmit = async (values: z.infer<typeof otpSchema>) => {
    try {
      ...
      // If OTP is valid, redirect to reset password form
      toast.success("Code verified! Please set your new password");
      router.push(`/reset-password?email=${encodeURIComponent(email)}&otp=${values.otp}`);
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-7xl grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        {/* Right Side - Reset Password OTP Form */}
